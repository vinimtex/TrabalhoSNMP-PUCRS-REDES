            ...
            <React.Fragment>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <br />
                        <input style={inputStyle} placeholder="Interface de Rede" />
                        <br />
                        <br />
                        ...
                        <br />
                        <input type='number' style={inputStyle} placeholder="Tempo em segundos para atualização" />
                        <br />
                        <button style={buttonStyle}>Começar! ;D</button>
                    </div>
                </div>
